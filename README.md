...
2. Deploy your smart contract
   The following command will create a development account and then build and deploy the contract located in `assembly/index.ts` using [`dev-deploy`](https://docs.near.org/tools/near-cli#near-dev-deploy).
